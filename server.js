...
setInterval(() => {
  http.get(`https://bot-strak.glitch.me`); ///تعديل مهم حط بدل 333م البروجكت
}, 280000);
...
const dev = ["715558366037934121"]; ///
const admin = "=";
var owner = "715558366037934121"; // Owner Bot Mention /// تعديل مهم حط ايدي حسابكتعديل مهم ايدي حسابك
...
client.on("ready", () => {
  ...
  console.log(`----------------`);
  console.log(
    `ON ${client.guilds.size} Servers '     Script By : المنتصر  `
  );
  console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
...
client.on("message", zaid => {
  if (zaid.content === "=bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@715558366037934121>`, true) // تعديل مهم عدل هذا الرقم لايدي حسابك
      .setImage("")
...
let room = "752277162513399969"; //تعديل مهم ايدي روم عد الاعضاء والترحيب ، روم صوتي
